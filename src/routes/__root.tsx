...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "بوتیک آنلاین نئو رزین؛ سینی، ساعت، زیورآلات و اکسسوری رزین دست‌ساز با طراحی لوکس سیاه و طلایی و امکان سفارش اختصاصی." },
      ...
      { name: "twitter:title", content: "نئو رزین | هنر رزین دست‌ساز، سیاه و طلا" },
